...
Download the app archive and matching `.sha256` file from [GitHub Releases](https://github.com/yuxino/fuwa/releases). The latest public release is 0.1.1 and uses the project's persistent local signing certificate; it is not signed with Apple Developer ID or notarized.
